...
__license__ = "Apache"
__version__ = "1.0"
__email__ = "mirjeta.pasha1@gmail.com; csanderf@asu.edu; and toluwaokunola@gmail.com>"
"""
...
## The old generate_stempo file
# def generate_stempo(data_set = 'real', data_thinning = 2, **kwargs):
#         """
...
def generate_stempo(data_set = 'real', data_thinning = 2,views=11, new_shape= (64,64),columnsshift=14, **kwargs):
        """
        Generate stempo observations
        """
        nt = kwargs['nt'] if ('nt' in kwargs) else 10
